...
@Composable
fun AddAudioDialog(onDismiss: () -> Unit, onAdd: (String, String) -> Unit) {
    var title by remember { mutableStateOf("") }
    var selectedPath by remember { mutableStateOf<String?>(null) }
    // val launcher = ... // Stubbed for KMP
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(onClick = { if (selectedPath != null && title.isNotEmpty()) onAdd(selectedPath!!, title) }) {
